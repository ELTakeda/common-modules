...
use Drupal\takeda_brightcove\Plugin\media\Source\BrightcoveVideo;
 ...
 */
class AddVideoForm extends AddFormBase {
  ...
  protected function getMediaType(FormStateInterface $form_state) {
    ...
    if (!$media_type->getSource() instanceof BrightcoveVideo) {
  ...
  protected function buildInputElement(array $form, FormStateInterface $form_state) {
    ...
    $form['container']['url'] = [
      ...
      '#description' => $this->t('Enter your video\'s Brightcove studio URL from <a href="https://studio.brightcove.com/">studio.brightcove.com</a>, in the format <em>https://studio.brightcove.com/products/videocloud/media/videos/VIDEOID</em>.'),
      '#required' => TRUE,
      '#attributes' => [
