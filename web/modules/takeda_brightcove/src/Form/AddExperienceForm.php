...
use Drupal\takeda_brightcove\Plugin\media\Source\BrightcoveExp;
 ...
 */
class AddExperienceForm extends AddFormBase {
  ...
  protected function getMediaType(FormStateInterface $form_state) {
    ...
    if (!$media_type->getSource() instanceof BrightcoveExp) {
  ...
  protected function buildInputElement(array $form, FormStateInterface $form_state) {
    ...
    $form['container']['url'] = [
      ...
      '#description' => $this->t('Enter a Brightcove studio URL from <a href="https://studio.brightcove.com/">studio.brightcove.com</a>, in the format <em>https://studio.brightcove.com/products/videocloud/experiences/edit/EXPERIENCEID/layout</em>.'),
      '#required' => TRUE,
      '#attributes' => [
        'placeholder' => 'https://studio.brightcove.com/...',
      ],
    ];
    ...
    if ($form_state->hasValue('url')) {
      ...
      if (!empty($url)) {
        ...
        if ($is_url &&  is_numeric($video_id)) {
          ...
          try {
            $this->brightcoveVideo->loadExperience($video_id);
          }
          catch(\Error $error){
