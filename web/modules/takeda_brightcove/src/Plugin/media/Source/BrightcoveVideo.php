 ...
 *
 * @MediaSource(
 *   id = "tak_brightcove_video",
 *   label = @Translation("Brightcove Video"),
 *   description = @Translation("Studio URL for a Brightcove video."),
 *   allowed_field_types = {
 *     "link",
 *     "string",
 *     "string_long",
 ...
 *   forms = {
 *     "media_library_add" = "Drupal\takeda_brightcove\Form\AddVideoForm",
 *   },
 * )
 */
class BrightcoveVideo extends MediaSourceBase {
