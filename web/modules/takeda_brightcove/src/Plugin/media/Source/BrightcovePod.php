...
/**
 * Provides a media source plugin for Brightcove Podcasts.
 *
 * @MediaSource(
 *   id = "tak_brightcove_pod",
 *   label = @Translation("Brightcove Podcast"),
 *   description = @Translation("Studio URL for a Brightcove podcast."),
 *   allowed_field_types = {
 *     "link",
 *     "string",
 *     "string_long",
 ...
 *   forms = {
 *     "media_library_add" = "Drupal\takeda_brightcove\Form\AddPodcastForm",
 *   },
 * )
 */
class BrightcovePod extends MediaSourceBase {

  /**
   * Key for "media type" metadata attribute.
   *
   * @var string
   */
  ...
  public function getMetadata(MediaInterface $media, $attribute_name) {
    ...
    switch ($attribute_name) {
      ...
      case static::METADATA_ATTRIBUTE_TYPE:
        return
        $media->get($this->configuration['source_field'])->type ?: 'video';
