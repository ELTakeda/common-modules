...
abstract class OpenIDConnectClientBase extends PluginBase implements OpenIDConnectClientInterface, ContainerFactoryPluginInterface {
   ...
   */
  protected $clientScopes = ['openid', 'email', 'offline_access'];
  ...
  public function getAuthEndpoint($scope, $needToRemoveDestination) {
  ...
  public function authorize($scope = 'openid email') {
    $response = new TrustedRedirectResponse($this->getAuthEndpoint($scope, TRUE));
   ...
   */
  public function getUrlOptions($scope, GeneratedUrl $redirect_uri) {
    return [
      'query' => [
